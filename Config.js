...
// Cloudinary
exports.CLOUD_NAME = process.env.CLOUD_NAME         || 'dcmr7dmyu'
exports.API_KEY    = process.env.API_KEY_CLOUDINARY || '699473156776729'
exports.API_SECRET = process.env.API_SECRET         || 'Ip3M4Jup6IIh4F3cLT3IzJ9stQY'
