 ...
 * @private
 */
exports.profilePicRules = { 'email': 'required|email' }

/**
 * Mensajes de error en caso de no se cumplan las profilePicRules en una solicitud.
 * @name profilePicMessage
 * @type {Object}
 * @property {string} 'required.email' - Caso: Omisión o error del email
 * @constant
 * @private
 */
exports.profilePicMessage = { 'required.email': 'El e-mail es necesario' }
