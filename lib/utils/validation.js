 ...
 * @name codeRules
 * @type {Object}
 * @property {string} code  - Campo code de la solicitud es obligatorio y debe
 * tener formato de entero
 * @constant
 * @private
 */
exports.codeRules = { 'code': 'required|integer' }

/**
 * Mensajes de error en caso de no se cumplan las updateRules en una solicitud.
 * @name codeMessage
 * @type {Object}
 * @property {string} 'required.code' - Caso: Omisión o error del code
 * @constant
 * @private
 */
exports.codeMessage = { 'required.code': 'El código es necesario' }
 ...
 * @private
 */
exports.emailRules = { 'email': 'required|email' }

/**
 * Mensajes de error en caso de no se cumplan las emailRules en una solicitud.
 * @name emailMessage
 * @type {Object}
 * @property {string} 'required.email' - Caso: Omisión o error del email
 * @constant
 * @private
 */
exports.emailMessage = { 'required.email': 'El e-mail es necesario' }

/**
 * Reglas que tienen que cumplir las solicitudes enviadas desde Front-End para
 * eliminar un vehículo del perfil de un usuario en la base de datos.
 * @name updateRules
 * @type {Object}
 * @property {string} email - Campo email de la solicitud es obligatorio y debe
 * tener formato de e-mail
...
/**
 * Mensajes de error en caso de no se cumplan las deleteRules en una solicitud.
 * @name deleteMessage
 * @type {Object}
 * @property {string} 'required.email'       - Caso: Omisión o error del email
 * @property {string} 'required.password'    - Caso: Omisión del password
